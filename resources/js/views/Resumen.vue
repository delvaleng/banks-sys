...
<v-card height="100%" class="pa-4">
    ...
    <v-card-title>
        <v-text-field dense v-model="search" append-icon="mdi-magnify" label="Búsqueda" single-line hide-details></v-text-field>
        <v-spacer></v-spacer>
        <!-- <v-btn align="right" small class="ma-2" outlined color="indigo" @click.stop="addAccount = true">
            Agregar una cuenta
    ...
    <template>
        <v-data-table dense :headers="headers" :search="search" :items="accounts" item-key="name" class="elevation-1">
    ...
    <div class="panel-heading font-weight-black ">Detalles de las Transacciones</div>

    <v-card-title>
        <v-text-field dense v-model="search2" append-icon="mdi-magnify" label="Búsqueda" single-line hide-details></v-text-field>
    </v-card-title>

    <template>
        <v-data-table dense :headers="headers2" :search="search2" :items="transacciones" item-key="name" class="elevation-1">
