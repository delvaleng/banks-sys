...
<div>
    ...
    <v-form ref="formAccountOther">
        <v-row class="ma-1">
            ...
            <v-col cols="12" md="6">
                <v-select single-line dense placeholder="Cuenta Origen" label="Cuenta Origen" :items="accounts" item-text="n_account" item-value="id" return-object @input="getAccount()" v-model="formAccountOther.origen" :rules="rules.accountother.origen">
                </v-select>
            </v-col>
            <v-col cols="12" md="6">
            </v-col>
            <v-col cols="12" md="6">
                <v-select single-line dense placeholder="Cuenta Destino" label="Cuenta Destino" :items="accountsOther" item-text="n_account" item-value="id" return-object @input="getAccount()" v-model="formAccountOther.destino"
                  :rules="rules.accountother.destino">
                </v-select>
            </v-col>
            <v-col md="6" cols="12">
                <v-text-field v-model="formAccountOther.costFormat" :rules="rules.accountother.costFormat" label="Monto a tranferir" placeholder="Monto a tranferir" @keypress="isNumberKey($event)" @blur="formatCost($event)" dense>
                </v-text-field>
            </v-col>
            <v-col cols="12" md="6">
            </v-col>
